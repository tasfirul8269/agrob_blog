            ...
            <div key={index} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-green-600 mt-1 font-medium">{stat.change} from last month</p>
                </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="h-64 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">Activity data visualization</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-semibold text-gray-900 w-10">65%</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-semibold text-gray-900 w-10">25%</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-semibold text-gray-900 w-10">10%</span>
                </div>
              </div>
            </div>
          </div>
